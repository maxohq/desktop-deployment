defmodule DesktopDeployment.Os.Macos.MakeRelease do
  ...
  defp respond(result) do
    Operation.log_error(result, "Error in Macos.MakeRelease")
  ...
  defp first_action(%Package{release: %Mix.Release{path: path} = rel} = pkg) do
    ...
    %{pkg | priv: Map.put(pkg.priv, :installer_name, dmg)} |> Result.ok()
  end
