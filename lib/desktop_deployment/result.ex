defmodule DesktopDeployment.Result do
  @moduledoc """
  """
  ...
  @doc "Wrap nil in error, otherwise OK"
  @spec ok_or_err_on_nil(any()) :: t()
  def ok_or_err_on_nil(nil), do: err(nil)
  def ok_or_err_on_nil(v), do: ok(v)
